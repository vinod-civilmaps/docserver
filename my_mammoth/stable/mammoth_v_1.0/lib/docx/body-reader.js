...
function BodyReader(options) {
    ...
    var xmlElementReaders = {
        ...
        "v:rect": function(element) {
            console.log("RECT_ATTRIBUTES", util.inspect(element, true, null));
            var hrAttrKey =  '{urn:schemas-microsoft-com:office:office}hr';
    ...
    function readBlip(element, blip) {
        ...
        var sizeProps = element.first("wp:extent").attributes;
    ...
    function findEmbeddedImageFile(relationshipId) {
        ...
        if (relationshipId == 'rId64' || relationshipId == 'rId65') {
            console.log("Missing_file_path ", path, util.inspect(docxFile, true, null),   util.inspect(docxFile.read(path), true, null) );
        }
        return {
            path: path,
